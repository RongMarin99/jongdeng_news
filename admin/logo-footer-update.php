              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Post Logo</label> <small class="text-danger">( Recommend image size 125 x 125 pixels. )</small>
                    <?php
                ...
                <div class="card-footer">
                  <button type="submit" name="update_footer_logo" class="btn btn-success">Update Post</button>
